                ...
                {isShowModal && (
                    ...
                    <div className="d-flex justify-content-between mb-5">
                        <div className="add-product-header-left">
                            <h1 className="fw-bold" style={{ color:"black"}}>Danh mục sản phẩm</h1>
                            <span className="fw-bold">Danh mục: #{category.id}</span>
                        </div>
                        <div className="d-flex align-items-center gap-2">
                            { !isEdit ? (
                                <>
                                <button className="btn btn-primary d-flex gap-2 d-flex align-items-center" onClick={handleEdit}>
