      ...
      <div className="flex" data-product-id={product.id}>
        <div className="flex flex-col justifi-between">
          <div className="">
            ...
            >
              <div className="rounded-xl border-[1px] border-gray-200 relative flex border-2 mb-2 p-6 bg-white">
                <button
              ...
              <h6
                className="mb-2 text-xs font-semibold line-clamp-3 text-wrap"
                style={{ height: "50px" }}
              >
                {product.name}
              </h6>
            ...
            <div className="flex gap-1 items-center">
              ...
              <span className="text-xs ms-1 text-red-600">
          ...
          <div className="">
            ...
            <div className="mb-0">
              ...
              new Date() < new Date(product.endSale) ? (
                <>
                  <h3 className="text-orange-500 mb-0 text-xl font-semibold">
                    {product.type_discount === "percent"
                      ? formatMoney(
                          product.regularPrice -
                            (product.regularPrice * product.discount) / 100
                        )
                      : formatMoney(product.regularPrice - product.discount)}
                  </h3>
                ...
                <>
                  <h3 className="text-orange-400 mb-0 text-xl font-semibold">
                    {formatMoney(product.regularPrice)}
                  </h3>
                </>
              )}
